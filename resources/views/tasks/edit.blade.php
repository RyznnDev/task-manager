...
<head>
    ...
    <script src="https://cdn.tailwindcss.com"></script><link rel="stylesheet" href="{{ asset('fontawesome/css/all.min.css') }}">
...
<body class="bg-slate-100 font-sans text-slate-800 antialiased min-h-screen py-10">
    ...
    <div class="max-w-xl mx-auto bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
        <h1 class="text-xl font-bold text-slate-900 border-b border-slate-100 pb-4 mb-6">Edit Tugas</h1>
        ...
        <form action="{{ route('tasks.update', $task->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="4" 
                    class="w-full text-sm border border-slate-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-slate-800">{{ $task->description }}</textarea>
            </div>
